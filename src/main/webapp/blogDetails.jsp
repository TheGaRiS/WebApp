...
<div class = "container mt-5">
    <h1>Blog</h1>
    <div each="el : ${post}" class="alert alert-info mt-2">
        <h3 text="${el.title}"/>
        <p text="${el.fullText}"/>
        <p><b>Author:</b> <span text="${el.author}"/></p>
        <p>Views: <span text="${el.views}"/></p>
        <a href="'/blog/' + ${el.id} + '/edit'" class="btn btn-warning">Update</a><br><br>
        <form action="'/blog/' + ${el.id} + '/remove'" method="post">
