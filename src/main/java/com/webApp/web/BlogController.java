...
public class BlogController {
    ...
    public String blogPostAdd(@RequestParam String title, @RequestParam String anons, @RequestParam String fullText, @RequestParam String author, Model model) {
        Post post = new Post(title, anons, fullText, author);
